...
exports.ConverterMilimeters = exports.ConverterPercent = exports.ConverterBytes = exports.ConverterTime = undefined;
...
var metrics = {
	...
	milimeters: {
		...
		action: _utils.Divide, // [Divide or Multiply]
		compare: _utils.More, // [More or Less]		
		regex: _utils.RegexFomat.milimeters,
		acceptNegative: false, // [true or false]
		expected: 'Expected input like 000 B', // message to show on error
		intervals: [{ desc: ' cm', quant: 10 }, { desc: ' m', quant: 100 }, { desc: ' km', quant: 100 }]
	}
};
...
var ConverterMilimeters = function ConverterMilimeters(props) {
	return Converter('milimeters', props);
};

exports.ConverterTime = ConverterTime;
exports.ConverterBytes = ConverterBytes;
exports.ConverterPercent = ConverterPercent;
exports.ConverterMilimeters = ConverterMilimeters;